...
from a_hetero_model_transfer import transfer_from_hetero_model_more,transfer_from_hetero_model_more_interval
import pdb
import random
...
if not args.use_pretrain:
    net = plain_net5(num_class=100)
    # net = plain_net5_5x5(num_class=100)
    # net = resnet5(num_classes=100)
    print('net:',net)
else:
    ...
    if not args.reduce_to_baseline:
        print('****************transfer**************')
        net = transfer_from_hetero_model_more_interval(net, net0) 
